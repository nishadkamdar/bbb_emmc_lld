#ifndef __SDHC_MMC_H__
#define __SDHC_MMC_H__
...
#define SDHC_BLKATTR_WML_BLOCK 0x80
...
extern int mmc_voltage_validation(void);
extern void emmc_print_cfg_info(void);
